...
export interface Vault extends BaseContract {
  ...
  methods: {
    ...
    getHash(_amount:number | string | BN, _nonce:number | string | BN): NonPayableTransactionObject<string>;
    ...
    setLottery(
        _startDateTime: number | string | BN,
        _endDateTime: number | string | BN,
        _ticketPrice: number | string | BN
      ): NonPayableTransactionObject<void>;
